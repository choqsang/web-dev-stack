...
public class Application {
	...
	public static void main(String[] args) {
		...
		/*
		 * 브랜드 상관없이, 가격 자유롭게, 세 가지 피자는 다 사용!
		 * 
		 ...
		 * */
//		
//		Pizza bul = new BulgogiPizza(20000, "피자헛");
//		Pizza pot = new PotatoPizza(22000, "미스터피자");
//		Pizza pin = new PineapplePizza(24000, "파파존스");
		// bul.recipe();
		// pot.recipe();
		// pin.recipe();

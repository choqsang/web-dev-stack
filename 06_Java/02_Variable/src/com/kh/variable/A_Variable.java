...
public class A_Variable {
	...
	public static void main(String[] args) {
		...
		// 실행할 메서드가 있는 클래스 생성 (new) : 본인 꺼여도 새롭게 만들어야지만 실행이 가능하다.
	...
	public void variableTest() {
		 ...
		 * 
		 * 자료형 변수명;
		 * - 자료형 : 어떤 값을 저장할 지, 어떤 크기의 메모리를 할당받을 지에 대한 정보
		...
		// 2. 문자형 : 2byte = 16bit
		char ch = 'a'; // 쌍따옴표가 아님(구분) // ch = 'ab'; => 에러 발생!
		
		// 3. 정수형 : 
		byte bNum = 1; // 1byte(=8bit) -> 2^8(2의 8승) = 256 (-128 ~ +127의 값이 들어간다. 0포함)
		// bNum = 128; => 에러 발생! 오버플로우(overflow)
		short sNum = 128; // 2byte(=16bit) -> 2^16
		int iNum = 922337283; // 4byte (기본)
		long lNum = 922337283458L; // 8byte(값의 크기), 맨 뒤에 대문자 엘(L) 붙여서 사용
		...
		String name = "이진용"; // 대문자로 시작하는 변수는 클래스의 일종이다. 자료형은 소문자로 시작되는 게 맞다!
		String name2 = new String("이진용"); // 위와 같음

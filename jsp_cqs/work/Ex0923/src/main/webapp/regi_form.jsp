...
<html>
	<head>
		...
		<!-- Ajax 사용을 위한 참조 : httpRequest.js 
		기존 스크립트에 붙여넣지 말고 반드시 별도의 태그를 만들어 추가할 것! -->
		...
		<form>
			<table border="1">
				...
				<tr>
					<td>아이디</td>
					<td>
					<input id="id" name="id" placeholder="아이디를 입력하세요" size="10" onInput="che()" >
					<!-- 중복 체크가 끝난 후 입력값이 변동될 수 있으므로 방지 -->
					<input type="button" value="중복체크" onClick="check_id()">
					</td>
					<!-- onChange 혹은 onInput : 상황에 따라 구분 -->
				</tr>
				...
				<tr>
					<td>주소</td>
					<td><input name="addr" placeholder="주소를 입력하세요"  /></td>
				</tr>
